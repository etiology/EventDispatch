...
class TestEventRouter:
    ...
    def _register_example_event_processor1(self, reg: EventRouter, event_type: str, err=None):
    ...
    def _register_example_event_processor2(self, reg: EventRouter, event_type: str, err=None):
        """ adds a test event processor to the registry """
        @reg.register_async_processor(event_type)
